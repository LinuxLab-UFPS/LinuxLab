...
const components: Components = {
  h1: ({ children }) => (
    <h1 className="text-3xl font-bold text-foreground mt-2 mb-4">{children}</h1>
  ),
  h2: ({ children }) => (
  ...
  p: ({ children }) => (
    <p className="text-base text-muted-foreground leading-7 my-4">{children}</p>
  ),
  ul: ({ children }) => (
    <ul className="list-disc pl-6 space-y-2 my-4 text-base text-muted-foreground">{children}</ul>
  ),
  ol: ({ children }) => (
    <ol className="list-decimal pl-6 space-y-2 my-4 text-base text-muted-foreground">{children}</ol>
  ),
