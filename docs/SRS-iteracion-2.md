...
Total de la iteración: 30 pruebas en verde, repartidas en 6 suites (7 preferencias, 3 terminal HTTP, 6 terminal-entorno, 3 heartbeat, 4 wsAuth, 7 gateway WebSocket). La suite completa del proyecto queda en 115 pruebas verdes, sumando las 21 de la iteración 1, las 30 de la iteración 2, las 36 de la iteración 3 y las 28 de la iteración 4.
