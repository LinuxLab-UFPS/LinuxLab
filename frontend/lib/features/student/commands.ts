...
export const COMMANDS: EssentialCommand[] = [
  ...
  { name: "rmdir", args: "<directorio>", description: "Borra un directorio vacío.", topicNumber: 3, subtopicId: "operaciones-directorios" },
  ...
  // 6 · Compresión
  { name: "gzip", args: "<archivo>", description: "Comprime un archivo.", topicNumber: 6, subtopicId: "comprimir" },
  { name: "unzip", args: "<archivo.zip>", description: "Extrae un archivo zip.", topicNumber: 6, subtopicId: "comprimir" },
